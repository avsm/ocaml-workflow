(* OASIS_START *)
(* DO NOT EDIT (digest: 3d509b8593bfa52700d4c5a29c88b0f2) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("lib/workflow", ["lib"])];
     lib_c = [("workflow", "lib", [])];
     flags =
       [
          (["oasis_library_workflow_cclib"; "link"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.ETest ("system", "linux"),
                 S [A "-cclib"; A "-lrt"])
            ]);
          (["oasis_library_workflow_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S []);
