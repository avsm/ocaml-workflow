...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5d43661a9fafe8db5e62889135b72a70) *)
(*
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$shm_pipe_test", []))];
          ...
          ("unix_rpc_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$unix_rpc_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("tcp_pipe_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$tcp_pipe_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("simplex_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$simplex_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["shmem_stubs.c"; "simplex_stubs.c"];
                      bs_data_files = [];
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "workflow";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "unix_rpc_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "unix_rpc_test.ml"; });
               Executable
                 ({
                     cs_name = "tcp_pipe_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "tcp_pipe_test.ml"; });
               Flag
                 ({
                     cs_name = "func_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      flag_description = Some "Build functional tests";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Test
                 ({
                     cs_name = "shm_pipe_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      test_run =
                        [
                           ...
                           (OASISExpr.EFlag "perf_tests", true)
                        ];
                      test_tools = [ExternalTool "ocamlbuild"];
                      });
               Executable
                 ({
                     cs_name = "simplex_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "simplex_test.ml"; });
               Executable
                 ({
                     cs_name = "flow_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "flow_test.ml"; });
               Test
                 ({
                     cs_name = "unix_rpc_test";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      test_run =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "func_tests", true)
                        ];
                      test_tools = [ExternalTool "ocamlbuild"];
                      });
               Test
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build perf tests";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "shm_pipe_test.ml"; });
               Test
                 ({
                     cs_name = "simplex_test";
                     cs_data = PropList.Data.create ();
