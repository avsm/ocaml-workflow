...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75bd76a04fd1249313968dfd4c1ca894) *)
(*
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Shm"; "Simplex"; "Shmem_pipe"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "shmem_pipe_test.ml"; 
                   });
               Test
                 ({
                     cs_name = "simplex_test";
